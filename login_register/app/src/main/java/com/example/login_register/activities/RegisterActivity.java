...
public class RegisterActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initViews(){
        ...
        appCompatTextViewLoginLink = (AppCompatTextView) findViewById(R.id.appCompaTextViewLoginLink);
    }
    ...
    public void onClick(View v){
        switch (v.getId()){
            case R.id.appCompatButtonRegister:
                postDataToSQLite();
                break;
            case R.id.appCompaTextViewLoginLink:
                finish();
                break;
        }
    }
    ...
    private void postDataToSQLite(){
        ...
        if (!inputValidation.isInputEditTexMaches(textInputEditTextPassword, textInputEditTextConfirmPassword,
                ...
                public void run() {
                    ...
                    if (!isFinishing()){
                        new AlertDialog.Builder(RegisterActivity.this)
                                .setTitle("Error")
                                .setMessage("this has email exist ")
                                .setCancelable(false)

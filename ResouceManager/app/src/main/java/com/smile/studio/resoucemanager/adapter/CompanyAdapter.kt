...
import com.smile.studio.resoucemanager.network.model.Company

class CompanyAdapter(val mContext: Context, val mData: ArrayList<Company>) : BaseAdapter() {

    fun addAll(mData: ArrayList<Company>) {

...
import com.smile.studio.resoucemanager.network.model.Status

class StatusAdapter(val mContext: Context, val mData: ArrayList<Status>) : BaseAdapter() {

    fun addAll(mData: ArrayList<Status>) {

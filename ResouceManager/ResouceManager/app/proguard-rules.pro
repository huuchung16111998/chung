...
#
# Starting width version 2.2 of the Android plugin for Gradle, these files are no longer used. Newer
# versions are distributed width the plugin and unpacked at build time. Files in this directory are
